...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230321163301_migrate")]
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 3, 21, 17, 33, 1, 176, DateTimeKind.Local).AddTicks(3550),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$GuGRxeDClvtXTZbJWHzSjO7IEKKysXULZ4DifkseRe/Wgq6MoX8EC",
