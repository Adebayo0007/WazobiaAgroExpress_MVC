...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230402231314_legit")]
    partial class legit
    {
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 4, 3, 0, 13, 14, 508, DateTimeKind.Local).AddTicks(3764),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            IsRegistered = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$EFRIb6wYlf85xGXxyryPWeXaWEWoTP4xFsM8a5wSHP0gvQAKpH2tG",
