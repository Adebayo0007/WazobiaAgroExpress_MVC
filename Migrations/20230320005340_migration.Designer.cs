...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230320005340_migration")]
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 3, 20, 1, 53, 39, 480, DateTimeKind.Local).AddTicks(5501),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$O/tLV5YezPfzF9VnRbSL7OhBCpsiD3M0HVKS9Dz.XDk1CXHh6x556",
