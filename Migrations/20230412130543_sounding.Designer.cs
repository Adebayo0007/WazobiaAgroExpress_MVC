...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230412130543_sounding")]
    partial class sounding
    {
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 4, 12, 14, 5, 42, 559, DateTimeKind.Local).AddTicks(5831),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            IsRegistered = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$UXAXhN9WlMs7LOnGLNfsmO9/h50h1TkqPvJfiezfVrKuDJRUZRb8K",
