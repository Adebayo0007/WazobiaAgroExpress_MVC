...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230411215225_sound")]
    partial class sound
    {
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 4, 11, 22, 52, 24, 649, DateTimeKind.Local).AddTicks(6899),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            IsRegistered = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$20W47AVPTu879efE.8ee5O3MPaejtaLngjiOK.ThG5ZMQK70QzLlK",
