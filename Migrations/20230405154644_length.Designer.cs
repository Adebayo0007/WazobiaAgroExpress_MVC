...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230405154644_length")]
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 4, 5, 16, 46, 43, 701, DateTimeKind.Local).AddTicks(2820),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            IsRegistered = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$vEnQPMNiqe0CHnTYwC6zlexgSIsBZc7cY5kXYsR2WvxFlmZPiLI/O",
