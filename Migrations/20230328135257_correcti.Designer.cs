...
namespace Agro_Express.Migrations
{
    ...
    [Migration("20230328135257_correcti")]
    partial class correcti
    {
            ...
            modelBuilder.Entity("Agro_Express.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = "37846734-732e-4149-8cec-6f43d1eb3f60",
                            DateCreated = new DateTime(2023, 3, 28, 14, 52, 57, 275, DateTimeKind.Local).AddTicks(557),
                            Email = "tijaniadebayoabdllahi@gmail.com",
                            Gender = 1,
                            IsActive = true,
                            Name = "Adebayo Addullah",
                            Password = "$2b$10$NMnwvA5oJC.da5YouuSWGeQzqFTVSmn6QeHpPPCF7jSfcnQ6MgHEq",
